...
type TransactionResult = "success" | "blocked" | "invalid";
export {}
// ---------- SETUP ACCOUNTS ----------
const alice: Account = {
    name: "Alice",
...
// ---------- DEPOSIT ----------
function deposit(account: Account, amount: number): TransactionResult {
    if (amount <= 0) {
...
// ---------- WITHDRAW ----------
function withdraw(account: Account, amount: number): TransactionResult {
    if (amount <= 0) {
        console.log("Invalid amount");
        return "invalid";
    }
...
// ---------- TRANSFER ----------
function transfer(sender: Account, receiver: Account, amount: number): TransactionResult {
    if (amount <= 0) {
        console.log("Invalid amount");
        return "invalid";
    }
